...
- 【待完成】Agent 综述了解（2~3天）
  - [Agent 架构综述：从 Prompt 到 Context](https://mp.weixin.qq.com/s/pIcZPDqYzXrE3i6Zh4sr-Q)（已读）
  - [几篇Agent综述合集](https://zhuanlan.zhihu.com/p/21147735813)（已读李飞飞多模块智能体-见md笔记）
  - [**Agent自进化综述**](https://arxiv.org/html/2507.21046v3#abstract)（已读）
- 【待完成】Agent记忆机制（1~2天）
...
- 【待完成】Agent 学习进化
  ...
  - [AdaCoder: An Adaptive Planning and Multi-Agent Framework for Function-Level Code Generation](https://arxiv.org/abs/2504.04220)
- 【待完成】MCP 学习实践
